...
public class OutputRDF {
	...
	public void printPubRDF(Publication pub, String sunyreachPubCode) {
	...
	public static void main(String args[]) {
		...
		String middleName = "";
		Author a = new Author(firstName, lastName, middleName, QueryUtils.isSunyReachMember(firstName, lastName));
		authors.add(a);
		...
		new OutputRDF().printPubRDF(p, "a123456788");
